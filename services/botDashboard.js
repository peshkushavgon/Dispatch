...
function getConfiguration() {
  return [
    ...
    { section: 'Triumph', key: 'UPSTASH_REDIS_REST_URL', label: 'Durable token store URL', required: true },
    { section: 'Triumph', key: 'UPSTASH_REDIS_REST_TOKEN', label: 'Durable token store token', required: true },
    { section: 'Triumph', key: 'TRIUMPH_TOKEN_ENCRYPTION_KEY', label: 'Token encryption key', required: true },
